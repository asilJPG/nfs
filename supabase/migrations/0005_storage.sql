-- Logo storage. Bucket ids are global to the project, hence the prefix. Public read (logos show inside the mini app for anyone with the
...
values ('stampy-logos', 'stampy-logos', true, 2097152,
